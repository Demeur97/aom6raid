...
#6 линия
        ...
        markup.add(item1, item2, item3, item4, item5, item8, menu) 
        bot.send_message(message.chat.id, "Выберите точку:", reply_markup = markup)
        ...
        bot.send_photo(message.chat.id, photo2, caption = "№1. Трорин, Троддар, Велундар, Харгрим, Ангрим (4 волна)\n\n Комментарий: Используем 2 скилл Трорина, Азариэль и Харгримом кидаем хил. Босс бьет 3 скиллом и получает ответ урона.")  
        #6 линия 9 точка
        #6 линия 10 точка
        #6 линия 11 точка
...
#Боссы
        ...
        markup.add(item1, item4, item5, item7, menu) 
        bot.send_message(message.chat.id, "Выберите точку:", reply_markup = markup)
    ...
    #Драконир 
        ...
        photo = open ('Пачки/АртусРойнар.jpg', 'rb')
        bot.send_photo(message.chat.id, photo, caption = "№1. Артус Магнус Сакриф Тирос Ройнар\n\nКомментарий:\nМожно на авто, с слабым паком могут возникнуть проблеме на 4 волне, где Драконир. На 4 волне можно использовать Диких эльфов")    
